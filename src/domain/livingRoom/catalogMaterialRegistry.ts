...
export const CATALOG_MATERIAL_TO_REGISTRY: Record<string, string> = {
  ...
  "material:core:glass-fluted:v1": LIVING_ROOM_MATERIAL_IDS.clearGlass,
  "material:core:glass-brown-tinted:v1": LIVING_ROOM_MATERIAL_IDS.clearGlass,
  "material:core:glass-matte:v1": LIVING_ROOM_MATERIAL_IDS.clearGlass,
  "material:core:glass-rough:v1": LIVING_ROOM_MATERIAL_IDS.clearGlass,
  "material:core:glass-toughened:v1": LIVING_ROOM_MATERIAL_IDS.clearGlass,
