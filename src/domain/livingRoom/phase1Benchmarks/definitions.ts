    ...
    cameras: [
      {
        ...
        position: { x: 1180, y: 1540, z: 3180 },
        target: { x: -200, y: 700, z: 200 },
        fieldOfViewDegrees: 42,
      },
      {
        key: "camera-b",
        name: "Corner establishing",
        position: { x: 2100, y: 1560, z: 3400 },
        target: { x: -400, y: 720, z: -200 },
    ...
    cameras: [
      {
        ...
        position: { x: 40, y: 1500, z: 2100 },
        target: { x: 0, y: 900, z: -1980 },
        fieldOfViewDegrees: 43,
      },
      {
        key: "camera-b",
        name: "Seating three-quarter",
        position: { x: 1680, y: 1520, z: 2860 },
        target: { x: -280, y: 680, z: 80 },
    ...
    cameras: [
      {
        ...
        position: { x: 980, y: 1520, z: 3020 },
        target: { x: -120, y: 680, z: 40 },
        fieldOfViewDegrees: 42,
      },
      {
        key: "camera-b",
        name: "Lamp / side table detail",
        position: { x: 1480, y: 1360, z: 420 },
        target: { x: 2200, y: 880, z: -1100 },
