...
import proofSlots from "./proofMaterialSlots.data.json" with { type: "json" };
import curatedSlotsA from "./curatedSlotsA.data.json" with { type: "json" };
import curatedSlotsB from "./curatedSlotsB.data.json" with { type: "json" };
import curatedSlotsC from "./curatedSlotsC.data.json" with { type: "json" };
