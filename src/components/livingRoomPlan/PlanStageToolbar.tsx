...
export function PlanStageToolbar(props: {
  ...
  return <header className="lr-plan-toolbar">
    <div className="lr-toolbar-group" data-group="edit"><span>Edit</span>
    ...
    <div className="lr-toolbar-group" data-group="transform"><span>Transform</span>
    ...
    <div className="lr-toolbar-group" data-group="align"><span>Align</span>
    ...
    <div className="lr-toolbar-group lr-toolbar-view" data-group="view"><span>View</span>
    ...
    <div className="lr-toolbar-group lr-toolbar-view" data-group="drawing"><span>Drawing</span>
