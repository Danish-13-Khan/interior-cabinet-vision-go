/** Product classification heuristics (mirrors src/domain/catalog/kenney/classification.ts). */
...
export function isArchitectureStem(stem) {
  return ARCHITECTURE.has(stem);
}

export function classifyKenneyStem(stem) {
