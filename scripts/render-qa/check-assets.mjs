...
const EXPECTED_TEXTURES = [
  ...
  "textures/wood/walnut-rough.png",
  "textures/fabric/oatmeal-color.png",
  "textures/fabric/oatmeal-normal.png",
  "textures/fabric/oatmeal-rough.png",
  "textures/fabric/olive-color.png",
  "textures/fabric/olive-normal.png",
  "textures/fabric/olive-rough.png",
  "textures/fabric/rug-wool-color.png",
  "textures/fabric/rug-wool-normal.png",
  "textures/fabric/rug-wool-rough.png",
  "textures/paint/wall-color.png",
  "textures/paint/wall-normal.png",
  "textures/paint/wall-rough.png",
  "textures/stone/warm-color.png",
  "textures/stone/warm-normal.png",
  "textures/stone/warm-rough.png",
